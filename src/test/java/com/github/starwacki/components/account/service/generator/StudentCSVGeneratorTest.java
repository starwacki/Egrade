...
class StudentCSVGeneratorTest {
    ...
    void generateStudents_givenNoExistFilePath_shouldThrowWrongFileException() {
        ...
        //then
        assertThrows(WrongFileException.class,() -> studentCSVGenerator.generateStudents(filePath));
    }
    ...
    void generateStudents_givenEmptyCsvFile_shouldThrowWrongFileExceptionWithEmptyInformationMessage() {
        ...
        //when
        Exception exception = assertThrows(WrongFileException.class, () -> studentCSVGenerator.generateStudents(filePath));
    ...
    void generateStudents_givenFileWith4Rows_shouldReturn4SizeList() throws IOException {
        ...
        //when
        List<AccountStudentDTO> accountStudentDTOList = studentCSVGenerator.generateStudents(filePath);
