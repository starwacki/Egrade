...
import com.github.starwacki.components.account.factory.AccountFactory;
...
class AccountServiceUnitTest {
    ...
    void saveTeacherAccount_givenTeacherAccountDTO_shouldSaveTeacher() {
        ...
        Teacher teacher = Teacher.builder()
                ...
                .subject(Subject.PHYSICS)
                .build();
        given(accountFactory.createTeacher(accountTeacherDTO)).willReturn(teacher);
    ...
    void saveTeacherAccount_givenTeacherAccountDTO_shouldReturnAccountViewDTOWithSameFieldsLikeGivingDTO() {
        ...
        Teacher teacher = Teacher.builder()
                ...
                .build();
        given(accountFactory.createTeacher(accountTeacherDTO)).willReturn(teacher);
        given(teacherRepository.save(accountFactory.createTeacher(accountTeacherDTO))).willReturn(teacher);
