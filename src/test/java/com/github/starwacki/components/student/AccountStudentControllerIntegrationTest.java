...
import com.github.starwacki.components.account.Role;
...
class AccountStudentControllerIntegrationTest {
    ...
    void addGradeToStudent_givenRolesWithoutPermissions_shouldReturn_403_HTTPStatus() throws Exception {
        ...
        //given
        int teacherID = teacherRepository.save(AccountTeacher
                .builder()
    ...
    void getStudentGrade_givenAnyRole_shouldReturn_200_HTTPStatus_andGradeViewDTOInResponseBody() throws Exception {
        ...
        //given
        AccountStudent accountStudent = (AccountStudent) studentRepository.findByUsername("username1").get();
        ...
        //when
        ResultActions resultActions = mockMvc.perform(get("/student/id="+ accountStudent.getId()+"/grade="+gradeId)
                .contentType(MediaType.APPLICATION_JSON));
    ...
    void deleteStudentGrade_givenRolesWithoutPermissions_shouldReturn_403_HTTPStatus() throws Exception {
        ...
        //when
        ResultActions resultActions = mockMvc.perform(delete("/student/id="+ accountStudent.getId()+"/grade="+gradeId)
                .contentType(MediaType.APPLICATION_JSON));
    ...
    void deleteStudentGrade_givenAdminOrTeacherRole_shouldReturn_200_HTTPStatus_andDeleteGradeFromDatabase() throws Exception {
        ...
        resultActions
                .andExpect(MockMvcResultMatchers.status().is(HttpStatus.OK.value()));
        assertThat(gradeRepository.findByStudentIdAndId(accountStudent.getId(),gradeId),
    ...
    void getStudentGrades_givenAnyRole_shouldReturn_200_HTTPStatus_andReturnGradesInResponseBody() throws Exception {
        ...
        //when
        ResultActions resultActions = mockMvc.perform(get("/student/id="+ accountStudent.getId()+"/grades")
                .contentType(MediaType.APPLICATION_JSON));
    ...
    void  getStudentSubjectGrades_givenAnyRole_shouldReturn_200_HTTPStatus_andReturnGradesInResponseBody() throws Exception {
        ...
        //when
        ResultActions resultActions = mockMvc.perform(get("/student/id="+ accountStudent.getId()+"/grades/subject="+subject.ordinal())
                .contentType(MediaType.APPLICATION_JSON));
