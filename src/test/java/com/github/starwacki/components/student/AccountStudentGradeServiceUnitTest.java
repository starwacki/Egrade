...
class AccountStudentGradeServiceUnitTest {
    ...
    private static Grade getGradeTest(int weight, Degree degree) {
        return Grade.builder()
                ...
                .id(0)
                .degree(degree)
                .addedBy(AccountTeacher.builder()
    ...
    void getOneSubjectGrades_givenNoExistSubjectID_shouldThrowSubjectNotFoundException() {
        ...
        given(studentRepository.findById(studentId)).willReturn(Optional.of(accountStudent));
    ...
    void  addGradeToStudent_givenGradeDTO_andNoExistTeacherId_shouldThrowStudentNotFoundException() {
        ...
        int addingTeacherId = 0;
        GradeDTO gradeDTO = getGradeDto(addingTeacherId);
        given(studentRepository.findById(studentId)).willReturn(Optional.of(mock(AccountStudent.class)));
    ...
    void  addGradeToStudent_givenGradeDTO_shouldSaveGradeToDatabase() {
        ...
        AccountTeacher accountTeacher = AccountTeacher
                ...
                .build();
        given(studentRepository.findById(studentId)).willReturn(Optional.of(accountStudent));
        given(teacherRepository.findById(addingTeacherId)).willReturn(Optional.of(accountTeacher));
    ...
    void updateGrade_givenStudent_andTeacherId_andGradeDTO_shouldSaveDtoToDatabase() {
        ...
        expectedGrade.setAccountStudent(accountStudent);
        expectedGrade.setAddedBy(accountTeacher);
