...
import com.github.starwacki.components.teacher.exceptions.TeacherAccountNotFoundException;
...
public class NotFoundExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {
             TeacherNotFoundException.class, GradeStudentNotFoundException.class,
